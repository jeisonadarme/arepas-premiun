export const Missing = () => {
    return (
        <section className="bg-gradient-to-b from-white-300 to-white-500 bg-gray-100">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div className="mx-auto max-w-screen-sm text-center">
                <p className="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">No logramos encontrar el producto que estas buscando.</p>
